...
choices = ['Failed (Excess Ambiguity)','Yes','Possible','Warning','Failed','Failed','No']
...
choices2 = ['Failed WGS QC','UK (B.1.1.7)','SA (B.1.351)','Brazil (P.1)','Nigerian (B.1.525)','Failed WGS QC',('Possible ' + df_VariantReqMatch0['watchlist_id']),('Possible Contamination with ' + df_VariantReqMatch0['lineage_x'] + ' and ' + df_VariantReqMatch0['watchlist_id']),'Not a VoC']
