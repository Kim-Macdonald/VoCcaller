...
conditions = [
    ...
    #(df_VariantReqMatch0['lineage_x'].isnull()),
    #(df_VariantReqMatch0['lineage_x'].eq('None')) & (df_VariantReqMatch0['pct_covered_bases'] == 0),
    ...
    (df_VariantReqMatch0['lineage_x'].isin(Other_values)),
    # Possibles:
    ...
    (~df_VariantReqMatch0['lineage_x'].eq('None')) & (pd.notnull(df_VariantReqMatch0['lineage_x'])) & (~df_VariantReqMatch0['lineage_x'].isin(Positive_values) | ~df_VariantReqMatch0['lineage_x'].isin(VUI_Values) | ~df_VariantReqMatch0['lineage_x'].isin(Other_values)) & (df_VariantReqMatch0['num_observed_mutations'] > 4),  
...
conditions2 = [
    ...
    (df_VariantReqMatch0['lineage_x'] == "B.1.617.1"),
    (df_VariantReqMatch0['lineage_x'] == "B.1.617.2"),
    (df_VariantReqMatch0['lineage_x'] == "B.1.617.3"),
    ...
    (df_VariantReqMatch0['lineage_x'] == "B.1.526.1"),
    (df_VariantReqMatch0['lineage_x'] == "P.1.1"),
    ...
    (df_VariantReqMatch0['lineage_x'] == "B.1.618"),
